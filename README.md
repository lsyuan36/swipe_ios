...
### ⚙️ **智能設置中心**
- **統計信息** - 詳細的照片整理統計和進度展示
- **JSON 備份** - 導出整理進度為 JSON 格式備份文件
- **數據導入** - 從 JSON 備份文件恢復整理進度
- **智能重置** - 安全的重置功能，支援確認對話框和加載動畫
...
- **設置中心** - 點擊設置按鈕訪問應用設置和管理功能
- **智能重置** - 在設置中重新開始整理，支援確認對話框和加載動畫
- **進度恢復** - 重啟應用自動恢復到上次位置
- **統計信息** - 即時查看整理進度和數量統計
